		...
		<section class="admin-content">
			<div class="container">
				...
				<div class="col-sm-6  form">
						<h2 class="pink-md-heading">Upload Image For Active Projects</h2>
		...
		<div class="conatiner">
			...
			foreach($data2 as $datas2) {
       		echo '<div class="row serach-result-main">
					...
					<a type="submit" href="'.base_url().'admincontroller/deleteDB2/'.$datas2['id'].' "class="btn btn-primary">Delete</a>
						</div>
						<div class="col-70-serach">
							<h4>'.$datas2['name'].'</h4>
							<h5>'.$datas2['location'].'</h5>
							<p>'.$datas2['description'].'</p>
						<!--<a type="submit" href="'.base_url().'admincontroller/updateDB2/'.$datas2['id'].' "class="btn btn-primary">Edit</a>-->
						</div>
					</div>
				</div>';
    		?>
