				...
				<div class="col-sm-6  form">
						...
						<?php echo form_open_multipart('calculatorcontroller/insert') ?>
							<div class="form-group">
								<input type="text" class="form-control" name="skeleton" placeholder="Insert Value of Skeleton..">
							</div>
							<div class="form-group">
								<input type="text" class="form-control" name="turnkey" placeholder="Insert Value of Turnkey..">
							</div>
