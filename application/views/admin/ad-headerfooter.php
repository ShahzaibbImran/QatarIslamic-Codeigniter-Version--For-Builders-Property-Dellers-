			...
			<div class="container">
				...
				<div class="col-sm-6  form">
						...
						<div class="form-group">
							<input type="text" class="form-control" name="fb" placeholder="Facebook Link.."  value = "<?=set_value('fb');?>" required>
						</div>
						
						<div class="form-group">
							<input type="text" class="form-control" name="twitter" placeholder="Twitter Link.."  value = "<?=set_value('twitter');?>" required>
						</div>
						<div class="form-group">
							<input type="text" class="form-control" name="instagram" placeholder="Instagram Link.."  value = "<?=set_value('instagram');?>" required>
						</div>
						<div class="form-group">
							<input type="text" class="form-control" name="email" placeholder="Email.."  value = "<?=set_value('email');?>" required>
						</div>
						<div class="form-group">
								<input type="text" class="form-control" name="number" placeholder="Number.."  value = "<?=set_value('number');?>" required>
							</div>
						  <button type="submit" name="submit" class="btn btn-primary">Upload Links</button>
					<?php echo form_close();?>
				</div>
			</div>
		</section>	
