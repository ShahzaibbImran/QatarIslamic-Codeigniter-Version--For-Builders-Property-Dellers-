			...
			<div class="container">
				...
				<div class="col-sm-6  form">
						...
						<div class="form-group">
							<input type="text" class="form-control" name="service_name1" placeholder="Name.."  value = "<?=set_value('service_name');?>" required>
						</div>
						<div class="form-group">
								<textarea class="form-control" rows="6" placeholder="Description..." name="service_description1" value="<?=set_value('service_description');?>" required=></textarea>
							</div>
