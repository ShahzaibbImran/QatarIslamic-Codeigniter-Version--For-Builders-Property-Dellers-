...
<script type="text/javascript">
  function myFunction() {
    alert("Successfully Image Inserted");
		...
		<section class="admin-content">
			<div class="container">
				...
				<div class="col-sm-6  form">
						<h2 class="pink-md-heading">Upload Image For Feature Projects</h2>
		...
		<div class="conatiner">
			<?php
    		$data2 = $this->db->get_where('gallery',array('project_cat' => 3));
			...
			foreach($data2 as $datas2) {
       		echo '<div class="row serach-result-main">
					...
					<div class="col-30-serach">
						...
						<a type="submit" href="'.base_url().'admincontroller/deleteDB3/'.$datas2['id'].' "class="btn btn-primary">Delete</a>
						</div>
						<div class="col-70-serach">
							<h4>'.$datas2['name'].'</h4>
							<h5>'.$datas2['location'].'</h5>
							<p>'.$datas2['description'].'</p>
						<!--<td><a type="submit" href="'.base_url().'admincontroller/updateDB3/'.$datas2['id'].' "class="btn btn-primary">Edit</a></td>-->
						</div>
					</div>
				</div>';
    		?>
			...
			<!-- <td><img src="<?php //echo $datas2['imageurl']?>"/></td>
			<td><?php //echo $datas2['name']?></td>
			<td><?php //echo $$datas2['location']?></td>
			<td><?php //echo $$datas2['description']?></td>
			<td><a type="submit" href="<?php //echo base_url() . "admincontroller/deleteDB1/" . $datas2['id']; ?>" class="btn btn-primary">Delete</a></td>
			</table> -->
			<!-- <td><a type="submit" href="<?php //echo base_url() . "admincontroller/deleteDB1/" . $datas2['id']; ?>" class="btn btn-primary">Delete</a></td> -->
